...
- MAC addresses, similar to unique house numbers in your neighborhood
- Network Interface Cards (NICs), like the mailboxes where letters are dropped off and collected
- Frames, which act like envelopes that carry information between nearby devices
- Ethernet and Wi-Fi, which determine how the “local roads” operate
